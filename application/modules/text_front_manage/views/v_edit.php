        ...
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header">
                  <h3 class="box-title">Edit Data Text</h3>
                  <hr style="margin-top:10px;margin-bottom:10px;">
                </div>
                <!-- /.box-header -->
                  <!-- form start -->
                  <form role="form" method="post" action="<?php echo site_url("text_front_manage/edit/".md5(sha1($detail->id_text))); ?>" >
                      <div class="box-body">
                          ...
                          <div class="row">
                            <div class="col-md-6 col-md-offset-3 col-sm-12">
                              ...
                              <div class="form-group <?php if(form_error('judul_text')){echo "has-error";} ?>">
                                ...
                                <input type="text" name="judul_text" class="form-control" id="judul_text" value="<?php if($act == "0") echo $detail->judul_text; if($act == "1") echo set_value('judul_text'); ?>" placeholder="Judul">
                              ...
                              <div class="form-group <?php if(form_error('isi_text')){echo "has-error";} ?>">
                                <label>Text</label>
                                <textarea name="isi_text" class="textarea form-control" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" placeholder="text ...">
                                  <?php if($act == "0") echo $detail->isi_text; if($act == "1") echo set_value("isi_text"); ?></textarea>
